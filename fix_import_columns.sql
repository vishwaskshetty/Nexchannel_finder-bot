...
CREATE INDEX IF NOT EXISTS idx_channels_source_name ON channels(source_name);
CREATE INDEX IF NOT EXISTS idx_channels_source_rank ON channels(source_rank);
CREATE INDEX IF NOT EXISTS idx_channels_language ON channels(language);
CREATE INDEX IF NOT EXISTS idx_channels_subscribers ON channels(subscribers_text);